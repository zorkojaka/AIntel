...
- **AIN-P3-02 foundation**: added shared frontend API envelope parser/helper and moved
  module-settings, module-projects, module-employees, module-profil,
  module-finance, and module-crm API parsing to it. Broader raw-fetch migration
  and toast/retry policy remain open.
