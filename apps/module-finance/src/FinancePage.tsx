  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      try {
        ...
        const resolvedRoles = (mePayload.data.roles ?? mePayload.data.employee?.roles ?? []) as Role[];
        const resolvedEmployeeId = mePayload.data.employeeId ?? mePayload.data.employee?.id ?? null;
