...
export function OfferVersionCard({ offer, onOpen, onPDF, onMarkAsSelected, onSend, onConfirm, onCancelConfirmation }: OfferVersionCardProps) {
  return (
    <Card className="p-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4 flex-1">
          <div className="font-semibold text-lg">v{offer.version}</div>
          ...
          <div className="font-semibold ml-auto">€ {offer.amount.toLocaleString("sl-SI", { minimumFractionDigits: 2 })}</div>
        </div>
